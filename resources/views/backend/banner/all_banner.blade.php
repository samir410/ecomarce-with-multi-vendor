...
@section('content')
    ...
    <div class="page-content">
        ...
        <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
            ...
            <div class="ms-auto">
                <a href="{{ route('add.banner') }}" class="btn btn-outline-dark">Add banner</a>
                    ...
                    <table id="example" class="table mb-0 table-dark table-striped table-hover table-bordered" style="width:100%">
                        ...
                        @foreach($banner as $key => $item)	
                            <tr class="align-bottom">
                                ...
                                <td>
                                    <a href="{{ route('edit.banner',$item->id) }}" class="btn btn-outline-primary glyphicon glyphicon-pencil">Edit</a>
                                    <a href="{{ route('delete.banner',$item->id) }}" class="btn btn-outline-danger" id="delete">Delete</a>
                                </td>
