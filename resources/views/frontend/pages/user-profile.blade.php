                            ...
                            <div class="tab-content account dashboard-content pl-50">
                                ...
                                <div class="tab-pane fade" id="account-detail" role="tabpanel" aria-labelledby="account-detail-tab">
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <p>Already have an account? <a href="{{ route('user.login') }}">Log in instead!</a></p>
                                            <form method="post" action="{{ route('user.store.profile') }}" enctype="multipart/form-data">
                                                @csrf
                                                <div class="row">
                                                    <div class="form-group col-md-6">
                                                        <label>Last Name <span class="required">*</span></label>
                                                        <input required="" class="form-control" id="name" value="{{ $userData->name }}" name="name" />
                                                    </div>
                                                    ...
                                                    <div class="form-group col-md-12">
                                                        ...
                                                        <input required="" class="form-control" id="email" value="{{ $userData->email }}" name="email" type="email" />
                                                    </div>
                                                    <div class="form-group col-md-12">
