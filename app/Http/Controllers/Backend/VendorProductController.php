...
class VendorProductController extends Controller
{
    ...
    public function AllProduct(){
        ...
        return view('vendor.backend.product.product_all',compact('products'));
    } // End Method 
    ...
    public function AddProduct(){
        ...
        return view('vendor.backend.product.product_add',compact('brands','categories'));
    ...
    public function ProductInactive($id)
    {
      ...
      public function EditProduct($id)
      {
          ...
          return view('vendor.backend.product.product_edit', compact('brands', 'categories', 'activeVendor', 'products', 'subcategory', 'multiImgs'));
      }// End Method
